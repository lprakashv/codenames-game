...
var periods__$1 = cljs.core.vec((function (){var G__56345 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56343_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__56343_SHARP_,(0),(3));
}),G__56345);
} else {
return G__56345;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__56366){
var vec__56367 = p__56366;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56367,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56367,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__56370 = pattern;
switch (G__56370) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56370)].join('')));
...
return p1__56373_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__56374_SHARP_){
return p1__56374_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__56375_SHARP_){
return p1__56375_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__56376_SHARP_){
return p1__56376_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__56377_SHARP_){
return p1__56377_SHARP_.getHours();
});

break;
case "day":
return (function (p1__56378_SHARP_){
return p1__56378_SHARP_.getDate();
});

break;
case "month":
return (function (p1__56379_SHARP_){
return p1__56379_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__56380_SHARP_){
return p1__56380_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56381__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__56382){
var vec__56383 = p__56382;
var seq__56384 = cljs.core.seq(vec__56383);
var first__56385 = cljs.core.first(seq__56384);
var seq__56384__$1 = cljs.core.next(seq__56384);
var key = first__56385;
var args = seq__56384__$1;
var G__56386 = key;
...
break;
case "ordinal-suffix":
var vec__56391 = (function (){var G__56394 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__56394) : syntax_list.call(null,G__56394));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56391,(0),null);
...
var d = value;
var G__56400 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__56401 = G__56400;
var seq__56402 = cljs.core.seq(vec__56401);
var first__56403 = cljs.core.first(seq__56402);
var seq__56402__$1 = cljs.core.next(seq__56402);
var unparser = first__56403;
var more = seq__56402__$1;
var s = "";
var d__$1 = d;
var G__56400__$1 = G__56400;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__56410 = G__56400__$1;
...
var unparser__$1 = first__56412;
var more__$1 = seq__56411__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__56413 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56413,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56413,(1),null);
var G__56459 = d__$3;
var G__56460 = more__$1;
var G__56461 = s__$3;
d__$1 = G__56459;
G__56400__$1 = G__56460;
s__$1 = G__56461;
continue;
}
break;
