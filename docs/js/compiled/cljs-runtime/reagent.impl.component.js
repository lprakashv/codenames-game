...
if((i < len)){
var k = (ks[i]);
var G__51821 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__51822 = (i + (1));
m = G__51821;
i = G__51822;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51701 = c;
var G__51701__$1 = (((G__51701 == null))?null:G__51701.prototype);
if((G__51701__$1 == null)){
return null;
} else {
return G__51701__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51706 = c;
var G__51706__$1 = (((G__51706 == null))?null:G__51706.prototype);
if((G__51706__$1 == null)){
return null;
} else {
return G__51706__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__51826__delegate = function (args){
var G__51718 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51718) : reagent.impl.component.as_element.call(null,G__51718));
};
...
while (G__51827__i < G__51827__a.length) {G__51827__a[G__51827__i] = arguments[G__51827__i + 0]; ++G__51827__i;}
  args = new cljs.core.IndexedSeq(G__51827__a,0,null);
} 
return G__51826__delegate.call(this,args);};
...
return G__51826__delegate(args);
});
...
var G__51719 = c;
var G__51719__$1 = (((G__51719 == null))?null:G__51719.constructor);
if((G__51719__$1 == null)){
return null;
} else {
return G__51719__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__51721 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51722 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51722);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51721);
}});
...
var c = this;
var G__51777_51833 = goog.object.get(c,"cljsRatom");
if((G__51777_51833 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51777_51833);
}
...
var renders_51835 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_51836 = cljs.core.first(cljs.core.vals(renders_51835));
...
if((cljs.core.count(renders_51835) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51835))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51836)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51836], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__51811 = o;
goog.object.set(G__51811,cljs.core.name(k),v);
