...
var G__58571 = pred;
var G__58572 = cljs_time.core.minus.cljs$core$IFn$_invoke$arity$2(date,period);
var G__58573 = period;
pred = G__58571;
date = G__58572;
period = G__58573;
...
return (function (p1__58378_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs_time.core.day_of_week(p1__58378_SHARP_),(d + (1)));
});
});
 ...
 */
re_com.datepicker.table_thead = (function re_com$datepicker$table_thead(display_month,p__58389){
var map__58391 = p__58389;
...
var show_weeks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58391__$1,new cljs.core.Keyword(null,"show-weeks?","show-weeks?",-1563135221));
var minimum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58391__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58391__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
var start_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58391__$1,new cljs.core.Keyword(null,"start-of-week","start-of-week",-1590603824));
...
return null;
})], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i.zmdi.zmdi-chevron-right","i.zmdi.zmdi-chevron-right",1358259812),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"24px"], null)], null)], null)], null)], 0)),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(template_row,(function (){var iter__4529__auto__ = (function re_com$datepicker$table_thead_$_iter__58408(s__58409){
return (new cljs.core.LazySeq(null,(function (){
var s__58409__$1 = s__58409;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58409__$1);
if(temp__5735__auto__){
var s__58409__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58409__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__58409__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__58411 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__58410 = (0);
while(true){
if((i__58410 < size__4528__auto__)){
var day = cljs.core._nth(c__4527__auto__,i__58410);
cljs.core.chunk_append(b__58411,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"day-enabled"], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(day))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(day)], null)));

var G__58620 = (i__58410 + (1));
i__58410 = G__58620;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58411),re_com$datepicker$table_thead_$_iter__58408(cljs.core.chunk_rest(s__58409__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58411),null);
}
} else {
var day = cljs.core.first(s__58409__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"day-enabled"], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(day))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(day)], null)),re_com$datepicker$table_thead_$_iter__58408(cljs.core.rest(s__58409__$2)));
}
} else {
return null;
}
...
return iter__4529__auto__(re_com.datepicker.rotate(start_of_week,re_com.datepicker.days_vector));
})())], null);
});
...
re_com.datepicker.table_td = (function re_com$datepicker$table_td(date,focus_month,selected,today,p__58430,disabled_QMARK_,on_change){
var map__58431 = p__58430;
...
var attributes = map__58431__$1;
var minimum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword(null,"minimum","minimum",-1621006059));
var maximum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58431__$1,new cljs.core.Keyword(null,"maximum","maximum",573880714));
var minimum__$1 = re_com.util.deref_or_value(minimum);
var maximum__$1 = re_com.util.deref_or_value(maximum);
...
var disabled_day_QMARK_ = (cljs.core.truth_(enabled_day)?cljs.core.not((function (){var fexpr__58433 = new cljs.core.Keyword(null,"selectable-fn","selectable-fn",-1997365738).cljs$core$IFn$_invoke$arity$1(attributes);
return (fexpr__58433.cljs$core$IFn$_invoke$arity$1 ? fexpr__58433.cljs$core$IFn$_invoke$arity$1(date) : fexpr__58433.call(null,date));
})()):true);
...
var row_dates = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58453_SHARP_){
return re_com.datepicker.inc_date(date,p1__58453_SHARP_);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(table_row,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58454_SHARP_){
return re_com.datepicker.table_td(p1__58454_SHARP_,focus_month,selected,today,attributes,disabled_QMARK_,on_change);
}),row_dates));
});
/**
...
var row_start_dates = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58455_SHARP_){
return re_com.datepicker.inc_date(current_start,((7) * p1__58455_SHARP_));
}),cljs.core.range.cljs$core$IFn$_invoke$arity$1((6)));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300)], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58457_SHARP_){
return re_com.datepicker.table_tr(p1__58457_SHARP_,focus_month,selected,attributes,disabled_QMARK_,on_change);
}),row_start_dates));
});
/**
...
var len__4736__auto___58655 = arguments.length;
var i__4737__auto___58656 = (0);
while(true){
if((i__4737__auto___58656 < len__4736__auto___58655)){
args__4742__auto__.push((arguments[i__4737__auto___58656]));

var G__58657 = (i__4737__auto___58656 + (1));
i__4737__auto___58656 = G__58657;
continue;
} else {
}
break;
...
(re_com.datepicker.datepicker.cljs$core$IFn$_invoke$arity$variadic = (function (p__58477){
...
var args = map__58478__$1;
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58478__$1,new cljs.core.Keyword(null,"model","model",331153215));
...
var display_month = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(cljs_time.core.first_day_of_the_month.cljs$core$IFn$_invoke$arity$1((function (){var or__4126__auto__ = cljs.core.deref(internal_model);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
return (function() { 
var re_com$datepicker$datepicker_component__delegate = function (p__58486){
...
var args__$1 = map__58487__$1;
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var start_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58487__$1,new cljs.core.Keyword(null,"start-of-week","start-of-week",-1590603824),(6));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58487__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
cljs.core.reset_BANG_(display_month,cljs_time.core.first_day_of_the_month.cljs$core$IFn$_invoke$arity$1((function (){var or__4126__auto__ = cljs.core.deref(internal_model);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return re_com.util.now__GT_utc();
...
var G__58688__i = 0, G__58688__a = new Array(arguments.length -  0);
while (G__58688__i < G__58688__a.length) {G__58688__a[G__58688__i] = arguments[G__58688__i + 0]; ++G__58688__i;}
  p__58486 = new cljs.core.IndexedSeq(G__58688__a,0,null);
} 
return re_com$datepicker$datepicker_component__delegate.call(this,p__58486);};
re_com$datepicker$datepicker_component.cljs$lang$maxFixedArity = 0;
re_com$datepicker$datepicker_component.cljs$lang$applyTo = (function (arglist__58690){
var p__58486 = cljs.core.seq(arglist__58690);
return re_com$datepicker$datepicker_component__delegate(p__58486);
});
...
/** @this {Function} */
(re_com.datepicker.datepicker.cljs$lang$applyTo = (function (seq58474){
...
var args__4742__auto__ = [];
var len__4736__auto___58710 = arguments.length;
var i__4737__auto___58712 = (0);
while(true){
if((i__4737__auto___58712 < len__4736__auto___58710)){
...
(re_com.datepicker.datepicker_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__58512){
...
return (function() { 
var G__58721__delegate = function (p__58525){
...
var passthrough_args = map__58526__$1;
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword(null,"model","model",331153215));
var show_weeks_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword(null,"show-weeks?","show-weeks?",-1563135221));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var no_clip_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58526__$1,new cljs.core.Keyword(null,"no-clip?","no-clip?",-188884951),true);
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
...
while (G__58740__i < G__58740__a.length) {G__58740__a[G__58740__i] = arguments[G__58740__i + 0]; ++G__58740__i;}
  p__58525 = new cljs.core.IndexedSeq(G__58740__a,0,null);
} 
return G__58721__delegate.call(this,p__58525);};
G__58721.cljs$lang$maxFixedArity = 0;
G__58721.cljs$lang$applyTo = (function (arglist__58741){
var p__58525 = cljs.core.seq(arglist__58741);
return G__58721__delegate(p__58525);
});
...
/** @this {Function} */
(re_com.datepicker.datepicker_dropdown.cljs$lang$applyTo = (function (seq58504){
var self__4724__auto__ = this;
