...
var G__58845 = cljs.tools.reader.reader_types.peek_char(rdr);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58845)){
...
var vec__58847 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58847,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58847,(1),null);
...
try{var map__58856 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
...
var foo = map__58856__$1;
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58856__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58856__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
...
try{var map__58869 = re_frisk.filter.filter_parser.read_string_SINGLEQUOTE_(s);
...
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58869__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58869__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"val","val",128701612),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"expr","expr",745722291),val], null),new cljs.core.Keyword(null,"rest","rest",-1241696419),rest], null);
}catch (e58862){var _ = e58862;
var vec__58863 = clojure.string.split.cljs$core$IFn$_invoke$arity$3(s,/\s+/,(2));
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58863,(0),null);
var rest = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58863,(1),null);
...
var G__58872 = cljs.core.first(s);
switch (G__58872) {
case "[":
case "(":
case "{":
...
var map__58877 = re_frisk.filter.filter_parser.parse_part(s__$2);
var map__58877__$1 = (((((!((map__58877 == null))))?(((((map__58877.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58877.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58877):map__58877);
var val = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58877__$1,new cljs.core.Keyword(null,"val","val",128701612));
var rest = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58877__$1,new cljs.core.Keyword(null,"rest","rest",-1241696419));
