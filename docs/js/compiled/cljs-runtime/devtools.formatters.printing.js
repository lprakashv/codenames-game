...
var len__4736__auto___42531 = arguments.length;
var i__4737__auto___42532 = (0);
while(true){
if((i__4737__auto___42532 < len__4736__auto___42531)){
args__4742__auto__.push((arguments[i__4737__auto___42532]));

var G__42533 = (i__4737__auto___42532 + (1));
i__4737__auto___42532 = G__42533;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42486){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42498_SHARP_){
return (!((cljs.core.meta(p1__42498_SHARP_) == null)));
})))){
...
var map__42506 = opts;
var map__42506__$1 = (((((!((map__42506 == null))))?(((((map__42506.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42506.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42506):map__42506);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42506__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42511){var _e__41611__auto__ = e42511;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42514){var _e__41611__auto__ = e42514;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42519 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42520 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42520);

try{var map__42524 = opts;
var map__42524__$1 = (((((!((map__42524 == null))))?(((((map__42524.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42524.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42524):map__42524);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42524__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42519);
}});
...
var temp__5733__auto___42546 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42546)){
var managed_print_level_42547 = temp__5733__auto___42546;
var _STAR_print_level_STAR__orig_val__42527_42548 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42528_42549 = managed_print_level_42547;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42528_42549);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42526_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42526_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42527_42548);
}} else {
job_fn();
}
