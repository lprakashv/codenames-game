...
var G__42482 = devtools.prefs.pref(v);
v = G__42482;
continue;
} else {
return v;
...
}catch (e42437){var _e__41611__auto__ = e42437;
return false;
}})();
...
}catch (e42443){var _e__41611__auto__ = e42443;
return false;
}})();
...
}catch (e42445){var _e__41611__auto__ = e42445;
return false;
}}
}
});
...
var vec__42462 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42462,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42462,(1),null);
...
return cljs.core.some((function (p1__42467_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42467_SHARP_);
}),template);
});
