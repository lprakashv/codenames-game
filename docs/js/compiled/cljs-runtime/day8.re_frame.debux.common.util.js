...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__65222){
var vec__65223 = p__65222;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65223,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65223,(1),null);
...
return clojure.zip.zipper((function (p1__65226_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__65226_SHARP_)) || (cljs.core.map_QMARK_(p1__65226_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__65229){
var vec__65230 = p__65229;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65230,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65230,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65236_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__65236_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65235_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__65235_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65237_SHARP_){
return (((p1__65237_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__65237_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__65242,mapping){
...
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65243__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65241_SHARP_){
if((p1__65241_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__65241_SHARP_);
} else {
return false;
}
}),day8.re_frame.debux.common.util.form_tree_seq(form)));
...
var G__65307 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__65308 = clojure.zip.next(loc);
loc = G__65308;
continue;
}
}
...
var len__4736__auto___65319 = arguments.length;
var i__4737__auto___65320 = (0);
while(true){
if((i__4737__auto___65320 < len__4736__auto___65319)){
args__4742__auto__.push((arguments[i__4737__auto___65320]));

var G__65321 = (i__4737__auto___65320 + (1));
i__4737__auto___65320 = G__65321;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__65265){
var vec__65266 = p__65265;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65266,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq65263){
var G__65264 = cljs.core.first(seq65263);
var seq65263__$1 = cljs.core.next(seq65263);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65264,seq65263__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__65269_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__65269_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__65271_65324 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__65272_65325 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__65273_65326 = true;
var _STAR_print_fn_STAR__temp_val__65274_65327 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__65273_65326);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__65274_65327);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__65272_65325);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__65271_65324);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__65270_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__65270_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__65331 = cljs.core.next(opts__$1);
var G__65332 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__65331;
acc = G__65332;
continue;
} else {
if(typeof f === 'string'){
var G__65334 = cljs.core.next(opts__$1);
var G__65335 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__65334;
acc = G__65335;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__65336 = cljs.core.nnext(opts__$1);
var G__65337 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__65336;
acc = G__65337;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__65339 = cljs.core.next(opts__$1);
var G__65340 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__65339;
acc = G__65340;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__65280 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__65280.cljs$core$IFn$_invoke$arity$1 ? fexpr__65280.cljs$core$IFn$_invoke$arity$1(f) : fexpr__65280.call(null,f));
})())){
var G__65345 = cljs.core.next(opts__$1);
var G__65346 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__65345;
acc = G__65346;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__65281 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__65281.cljs$core$IFn$_invoke$arity$1 ? fexpr__65281.cljs$core$IFn$_invoke$arity$1(f) : fexpr__65281.call(null,f));
})())){
var G__65347 = cljs.core.nnext(opts__$1);
var G__65348 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__65347;
acc = G__65348;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__65349 = cljs.core.next(opts__$1);
var G__65350 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__65349;
acc = G__65350;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__65282){
var vec__65283 = p__65282;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65283,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65283,(1),null);
...
var G__65287 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__65286 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__65286.cljs$core$IFn$_invoke$arity$1 ? fexpr__65286.cljs$core$IFn$_invoke$arity$1(G__65287) : fexpr__65286.call(null,G__65287));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__65293 = quoted_form;
var G__65294 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__65293,G__65294) : day8.re_frame.debux.common.util.remove_d.call(null,G__65293,G__65294));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__65295 = quoted_form;
var G__65296 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__65295,G__65296) : day8.re_frame.debux.common.util.remove_d.call(null,G__65295,G__65296));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__65355__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__65298 = quoted_form;
var G__65299 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__65298,G__65299) : day8.re_frame.debux.common.util.remove_d.call(null,G__65298,G__65299));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__65355 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__65359__i = 0, G__65359__a = new Array(arguments.length -  0);
while (G__65359__i < G__65359__a.length) {G__65359__a[G__65359__i] = arguments[G__65359__i + 0]; ++G__65359__i;}
  arg = new cljs.core.IndexedSeq(G__65359__a,0,null);
} 
return G__65355__delegate.call(this,arg);};
G__65355.cljs$lang$maxFixedArity = 0;
G__65355.cljs$lang$applyTo = (function (arglist__65360){
var arg = cljs.core.seq(arglist__65360);
return G__65355__delegate(arg);
});
G__65355.cljs$core$IFn$_invoke$arity$variadic = G__65355__delegate;
return G__65355;
})()
;
});
...
var G__65361 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__65361;
continue;
} else {
...
var G__65362 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__65362;
continue;
} else {
var G__65363 = clojure.zip.next(loc);
loc = G__65363;
continue;
