...
var G__51832 = o;
goog.object.set(G__51832,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51892__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51892 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51893__i = 0, G__51893__a = new Array(arguments.length -  0);
while (G__51893__i < G__51893__a.length) {G__51893__a[G__51893__i] = arguments[G__51893__i + 0]; ++G__51893__i;}
  args = new cljs.core.IndexedSeq(G__51893__a,0,null);
} 
return G__51892__delegate.call(this,args);};
G__51892.cljs$lang$maxFixedArity = 0;
G__51892.cljs$lang$applyTo = (function (arglist__51894){
var args = cljs.core.seq(arglist__51894);
return G__51892__delegate(args);
});
G__51892.cljs$core$IFn$_invoke$arity$variadic = G__51892__delegate;
return G__51892;
})()
;
} else {
...
var G__51838 = o;
goog.object.set(G__51838,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51896__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51896 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51899__i = 0, G__51899__a = new Array(arguments.length -  0);
while (G__51899__i < G__51899__a.length) {G__51899__a[G__51899__i] = arguments[G__51899__i + 0]; ++G__51899__i;}
  args = new cljs.core.IndexedSeq(G__51899__a,0,null);
} 
return G__51896__delegate.call(this,args);};
G__51896.cljs$lang$maxFixedArity = 0;
G__51896.cljs$lang$applyTo = (function (arglist__51900){
var args = cljs.core.seq(arglist__51900);
return G__51896__delegate(args);
});
...
var G__51840 = props;
var G__51840__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51840,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51840);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51840__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51840__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51841 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51841,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51841;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51844){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51845__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51848_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51848_SHARP_);
}));
} else {
return null;
}
...
var vec__51855 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51855,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51855,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51855,(2),null);
...
var temp__5739__auto___51917 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51917 == null)){
} else {
var key_51918 = temp__5739__auto___51917;
(jsprops.key = key_51918);
}
...
var temp__5739__auto___51919 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51919 == null)){
} else {
var key_51920 = temp__5739__auto___51919;
(jsprops.key = key_51920);
}
...
var G__51865 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51865) : reagent.impl.template.as_element.call(null,G__51865));
} else {
var temp__5739__auto___51928 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___51928 == null)){
} else {
var key_51933 = temp__5739__auto___51928;
(jsprops.key = key_51933);
}
...
var G__51868 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51868)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__51868)){
return x;
} else {
...
var i__4737__auto___51948 = (0);
while(true){
if((i__4737__auto___51948 < len__4736__auto___51946)){
args__4742__auto__.push((arguments[i__4737__auto___51948]));

var G__51950 = (i__4737__auto___51948 + (1));
i__4737__auto___51948 = G__51950;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51869){
var G__51870 = cljs.core.first(seq51869);
var seq51869__$1 = cljs.core.next(seq51869);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51870,seq51869__$1);
}));
...
break;
default:
var G__51957 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51957;
continue;
...
var ctx = ({});
var vec__51884 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51884,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51884,(1),null);
...
var G__51888 = (cljs.core.count(argv) - first_child);
switch (G__51888) {
case (0):
