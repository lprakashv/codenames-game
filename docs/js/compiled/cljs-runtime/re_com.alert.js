...
var len__4736__auto___58627 = arguments.length;
var i__4737__auto___58628 = (0);
while(true){
if((i__4737__auto___58628 < len__4736__auto___58627)){
args__4742__auto__.push((arguments[i__4737__auto___58628]));

var G__58629 = (i__4737__auto___58628 + (1));
i__4737__auto___58628 = G__58629;
continue;
} else {
}
break;
...
(re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__58521){
var map__58522 = p__58521;
var map__58522__$1 = (((((!((map__58522 == null))))?(((((map__58522.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58522.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58522):map__58522);
var args = map__58522__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58522__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),new cljs.core.Keyword(null,"info","info",-317069002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58522__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
...
var alert_class = (function (){var G__58536 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"none","none",1333468478),"",new cljs.core.Keyword(null,"info","info",-317069002),"alert-success",new cljs.core.Keyword(null,"warning","warning",-1685650671),"alert-warning",new cljs.core.Keyword(null,"danger","danger",-624338030),"alert-danger"], null);
return (alert_type.cljs$core$IFn$_invoke$arity$1 ? alert_type.cljs$core$IFn$_invoke$arity$1(G__58536) : alert_type.call(null,G__58536));
})();
...
/** @this {Function} */
(re_com.alert.alert_box.cljs$lang$applyTo = (function (seq58507){
...
var args__4742__auto__ = [];
var len__4736__auto___58637 = arguments.length;
var i__4737__auto___58638 = (0);
while(true){
if((i__4737__auto___58638 < len__4736__auto___58637)){
args__4742__auto__.push((arguments[i__4737__auto___58638]));

var G__58642 = (i__4737__auto___58638 + (1));
i__4737__auto___58638 = G__58642;
continue;
} else {
}
break;
...
(re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__58566){
...
var args = map__58567__$1;
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var border_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"border-style","border-style",-485574304));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var alert_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"alert-style","alert-style",-768560399));
var alert_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"alert-class","alert-class",97354097));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var alerts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58567__$1,new cljs.core.Keyword(null,"alerts","alerts",-2121664427));
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58567__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),"4px");
...
var c__4527__auto__ = cljs.core.chunk_first(s__58595__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__58597 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__58596 = (0);
while(true){
if((i__58596 < size__4528__auto__)){
var alert = cljs.core._nth(c__4527__auto__,i__58596);
cljs.core.chunk_append(b__58597,(function (){var map__58608 = alert;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58597),re_com$alert$iter__58594(cljs.core.chunk_rest(s__58595__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58597),null);
}
} else {
var alert = cljs.core.first(s__58595__$2);
return cljs.core.cons((function (){var map__58610 = alert;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58610__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 19, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),alert_type,new cljs.core.Keyword(null,"heading","heading",-1312171873),heading,new cljs.core.Keyword(null,"body","body",-2049205669),body,new cljs.core.Keyword(null,"padding","padding",1660304693),padding__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),closeable_QMARK_,new cljs.core.Keyword(null,"on-close","on-close",-761178394),on_close,new cljs.core.Keyword(null,"class","class",-2030961996),alert_class,new cljs.core.Keyword(null,"style","style",-496642736),alert_style], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),re_com$alert$iter__58594(cljs.core.rest(s__58595__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(re_com.alert.alert_list.cljs$lang$applyTo = (function (seq58564){
var self__4724__auto__ = this;
