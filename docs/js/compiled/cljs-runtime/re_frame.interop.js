...
return [(function (){var pred__52146 = cljs.core.instance_QMARK_;
var expr__52147 = reactive_val;
if(cljs.core.truth_((pred__52146.cljs$core$IFn$_invoke$arity$2 ? pred__52146.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52147) : pred__52146.call(null,reagent.ratom.RAtom,expr__52147)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52146.cljs$core$IFn$_invoke$arity$2 ? pred__52146.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52147) : pred__52146.call(null,reagent.ratom.RCursor,expr__52147)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52146.cljs$core$IFn$_invoke$arity$2 ? pred__52146.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52147) : pred__52146.call(null,reagent.ratom.Reaction,expr__52147)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52146.cljs$core$IFn$_invoke$arity$2 ? pred__52146.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52147) : pred__52146.call(null,reagent.ratom.Track,expr__52147)))){
return "tr";
} else {
return "other";
}
